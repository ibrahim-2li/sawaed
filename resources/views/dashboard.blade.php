...
<body class="bg-gray-100 text-gray-800">
    ...
    <div class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8" x-data="{ 
        ...
        <div class="flex space-x-4 space-x-reverse mb-6 border-b border-gray-200">
            ...
            <button @click="activeTab = 'messages'" :class="{ 'border-primary-600 text-primary-600': activeTab === 'messages', 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300': activeTab !== 'messages' }" class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm relative">
                الرسائل
                            ...
                            <li class="px-4 py-5 sm:px-6 {{ $contact->is_read ? 'bg-white' : 'bg-blue-50' }}" x-data="{ expanded: false }">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1 min-w-0 cursor-pointer" @click="expanded = !expanded">
                                        ...
                                        <p class="text-sm text-gray-600 line-clamp-2" x-show="!expanded">
                                            {{ Str::limit($contact->message, 100) }}
                                        </p>
                                        <div x-show="expanded" class="mt-3">
                                            <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                                <p class="text-sm font-medium text-gray-700 mb-2">الرسالة:</p>
                                                <p class="text-sm text-gray-800 whitespace-pre-wrap leading-relaxed">{{ $contact->message }}</p>
                                            </div>
                                        </div>
                                    </div>
