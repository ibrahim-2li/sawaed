        ...
        <form wire:submit.prevent="update">
            ...
            <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                <div class="sm:col-span-3">
                    <label class="block text-sm font-medium text-gray-700">اسم العلامة التجارية</label>
                ...
                <div class="sm:col-span-6">
                    <label class="block text-sm font-medium text-gray-700">شعار العلامة التجارية</label>
                    @if ($new_logo)
